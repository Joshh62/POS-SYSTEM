...
const DOC_CONTENT = {
  ...
  terms: [
    ...
    { h: `4. Free Trial`, b: `New accounts receive a 14-day free trial with full access to the features of their selected plan. No payment method is required to start the trial. At the end of the trial period, access is suspended until a valid subscription payment is made. Trial data is retained for 30 days after trial expiry.` },
    { h: `5. Subscription and Payment`, b: `5.1 Plans — ProfitTrack offers four plans: Solo, Starter, Business, and Enterprise. Plan features and pricing are described at profittrack.ng.\n\n5.2 Billing — Subscriptions are billed monthly or annually in advance in Nigerian Naira (NGN) via Paystack.\n\n5.3 Plan upgrades — Take effect immediately upon payment.\n\n5.4 Plan downgrades — Scheduled for end of current billing period. No refund issued for the difference.\n\n5.5 No refunds — All payments are final and non-refundable. The 14-day free trial exists to allow evaluation before paying.\n\n5.6 Payment failures — 3-day grace period to update payment method. After 3 days, access is suspended.` },
  ...
  refund: [
    ...
    { h: `1. No-Refund Policy`, b: `ProfitTrack subscription payments are non-refundable. By subscribing, customers acknowledge that they have evaluated the product during the 14-day free trial and are satisfied that it meets their needs.\n\nThe free trial period exists specifically to allow full evaluation before any payment is required.` },
    { h: `2. The 14-Day Free Trial`, b: `All ProfitTrack plans include a 14-day free trial with full access to the features of the selected plan. No payment method is required to start a trial. Requests for refunds citing dissatisfaction that could have been identified during the trial period will not be approved.` },
